            ...
            <>
...

              {
                showFollowingsReviews ?
                  ...
                  <ReviewsInfiniteScrollContainer key={uuidv4()} userId={props.user.id} sortByNewest={sortByNewest} />
                :
                  <ReviewsInfiniteScrollContainer key={uuidv4()} userId={false} sortByNewest={sortByNewest} />
              }   
            </>
          :
            <ReviewsInfiniteScrollContainer key={uuidv4()} userId={false} sortByNewest={sortByNewest} />  
